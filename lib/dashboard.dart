                    ...
                    child: Column(
                        children: [
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("Hello, Precious!",style:
                                  TextStyle(
                                    color: Colors.white,
                                    fontSize: 18,
                                  ),),
                          ...
                          Padding(
                            ...
                            child: Text('Su/Pre123'),
                          ),
                          Divider(),
                          carouselSlided("assets/images/img.png",'SURTRAQ CURRENCY', 'Q190,000'),
                          Divider(),
                          new DotsIndicator(
                            dotsCount: 3,
                            position: _value,
              ...
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Icon(Icons.remove_red_eye_outlined,size:
                      15,),
                  ),
                ],
              ),
